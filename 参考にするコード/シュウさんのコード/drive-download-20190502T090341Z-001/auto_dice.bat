...
set data2=D:\comp30\RawData_hist\hist0_5big\img00
set orgdata=D:\comp30\RawData\Training\label\label00

set logdir=D:\comp30\Script\log_org_weightloss
set logdir2=D:\comp30\Script\log_05b_weightloss_again
md %logdir%\result
md %logdir2%\result
::file name
set ct=.nii\ct.mha
set cthist=.nii\hist_05_b.mha
set label=.nii\label_8.mha

set label_mask=.nii\mask_8.mha
set weight1=%logdir%\model\model_30_19.67.hdf5
